...
Learning assesment: In the pups_df, select columns containing litter
...
supposed we wanted to import, clean, select group, get rid of things
with gd, get rid of anything missing variable, add weight gain variable
...
Use pipes to avoid all of this (command shift m) I added the
show_col_types / not in lecture becasue it wouldn’t run the table
...
```
    ...
    ##  1 Con7  #85                 19.7        34.7          20    15  
    ##  2 Con7  #1/2/95/2           27          42            19    15  
    ##  3 Con7  #5/5/3/83/3-3       26          41.4          19    15.4
    ##  4 Con7  #5/4/2/95/2         28.5        44.1          19    15.6
    ##  5 Mod7  #59                 17          33.4          19    16.4
    ##  6 Mod7  #103                21.4        42.1          19    20.7
    ##  7 Mod7  #3/82/3-2           28          45.9          20    17.9
    ##  8 Mod7  #5/3/83/5-2         22.6        37            19    14.4
    ##  9 Mod7  #106                21.7        37.8          20    16.1
    ## 10 Mod7  #94/2               24.4        42.9          19    18.5
    ## # ℹ 21 more rows

Learning assessment: load pups data, clean the variable names, filter
the data to include only pups with sex 1, remove the pd ears variablle,
create a new variable that indicates whether PD pivot is 7 or more days
